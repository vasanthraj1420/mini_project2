...
web = option_menu(menu_title="🔴Stock Analysis🟢",options=["💲Home", "📉Data Analysis & Visualization"],icons=[":house:", "info-circle"],orientation="horizontal")
if web == "💲Home":
...
if web=="📉Data Analysis & Visualization":
    s=st.selectbox('stocks Analysis & Visualization',["Volatility Analysis","Cumulative Return Over Time","Sector-wise Performance","Stock Price Correlation","Top 5 Gainers and Losers (Month-wise)"])
